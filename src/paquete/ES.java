...
public class ES {
     ...
     *   es mayor que el mínimo.
     */
    public static double leeDecimal(String mensaje) throws IllegalArgumentException {
        double numero = 0;
        boolean leido = false;
        Scanner teclado = null;
     ...
     * mostrando por pantalla la pregunta en cuestión. S�lo se admiten como
     * respuestas
     *
     * @param mensaje  Es el mensaje que se envía con la pregunta cuya
     * respuesta se espera que sea S� o No.
